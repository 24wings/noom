export let loginGetAllDto = {
  result: {
    multiTenancy: {
      isEnabled: true,
      ignoreFeatureCheckForHostUsers: false,
      sides: { host: 'Host', tenant: 'Tenant' },
    },
    session: {
      userId: 1,
      tenantId: null,
    ...
    localization: {
      currentCulture: { name: 'zh-Hans', displayName: 'zh (Hans)' },
      languages: [
        {
          name: 'zh-Hans',
          displayName: '简体中文',
      ...
      sources: [
        ...
        { name: 'eShopLinker', type: 'MultiTenantLocalizationSource' },
      ],
      values: {
        Abp: {
    ...
    features: {
      allFeatures: {
        'App.MaxUserCount': { value: '0' },
        TestTenantScopeFeature: { value: 'false' },
        TestEditionScopeFeature: { value: 'false' },
        'App.TestCheckFeature': { value: 'false' },
        'App.TestCheckFeature2': { value: 'true' },
        'App.ChatFeature': { value: 'false' },
        'App.ChatFeature.TenantToTenant': { value: 'false' },
        'App.ChatFeature.TenantToHost': { value: 'false' },
      },
    },
    auth: {
      allPermissions: {
